...
export default function AboutSection() {
    ...
    const achievement = [
        "Secured Global Rank 186 (Top 200 worldwide) in Meta Hacker Cup 2025 among 20,000+ participants, advancing from Global 1,436 to 446 to 186 across three rounds.",
        ...
        "Leetcode Knight with 860+ problems solved and a peak rating of 2012",
        "Codeforces Specialist with a peak rating of 1572",
  ...
  return (
    <section id='about' className='text-white mb-5 scroll-mt-32' >
            ...
            <p className="text-gray-300 text-base sm:text-lg lg:text-xl text-justify leading-relaxed">
                I am a Software Engineer from Delhi Technological University with a strong focus on Machine Learning, Competitive Programming, and Full Stack Web Development.
                With over <span className="text-cyan-400 font-semibold">1200+ Data Structures and Algorithms problems</span> solved, I bring a solid foundation in algorithmic thinking and problem-solving.
